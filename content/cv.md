...
- Open-source Python package for building hive plots, a network visualization technique. Available on [PyPI](https://pypi.org/project/hiveplotlib/) with [online documentation](https://hiveplotlib.readthedocs.io/stable/).
...
- Developed a novel visualization technique combining concepts from parallel coordinates plots and hive plots. Implemented in hiveplotlib as of v0.16. Paper on [arXiv](https://arxiv.org/abs/2109.10193).

## Selected Publications

Full list on [Google Scholar](https://scholar.google.com/citations?hl=en&user=tKSgCikAAAAJ).

- **Koplik, Gary**, Nathan Borggren, Sam Voisin, Gabrielle Angeloro, Jay Hineman, Tessa Johnson, and Paul Bendich. "Topological Simplification of Signals for Inference and Approximate Reconstruction." In *2023 IEEE Aerospace Conference*, pp. 1-11. IEEE, 2023. ([IEEE Xplore](https://ieeexplore.ieee.org/abstract/document/10115654), [arXiv](https://arxiv.org/abs/2206.07486))
- Ball, Kenneth, Erin Taylor, Nirav Patel, Andrew Bartels, **Gary Koplik**, James Polly, and Jay Hineman. "Geometric Feature Prompting of Image Segmentation Models." [arXiv](https://arxiv.org/abs/2505.21644), 2025.
- Voisin, Sam, Jay Hineman, James B. Polly, **Gary Koplik**, Ken Ball, Paul Bendich, Joseph D'Addezio, Gregg A. Jacobs, and Tamay Özgökmen. "Topological Feature Tracking for Submesoscale Eddies." *Geophysical Research Letters* 49, no. 20 (2022). ([doi](https://doi.org/10.1029/2022GL099416))
- **Koplik, Gary**, and Ashlee Valente. "The Parallel Coordinates Plot Revisited: Visual Extensions from Hive Plots." [arXiv](https://arxiv.org/abs/2109.10193), 2021.
...
**Duke University** &middot; *Durham, NC*<br>
M.S. Economics and Computer Science &middot; *May 2018*

**Colby College** &middot; *Waterville, ME*<br>
B.A. Economics, Mathematical Science &middot; *May 2016*<br>
*Summa Cum Laude, Phi Beta Kappa*

**Phillips Exeter Academy** &middot; *Exeter, NH*<br>
*June 2012*
